...
Para este trabajo elegimos un dataset de los habitos alimenticios y condicion fisicas de individuos entre 14 y 61 años de los países de México, Perú y Colombia. La información contiene 17 atributos y 2111 observaciones. El 77% de los datos fue generado sintéticamente utilizando la herramienta Weka y el filtro SMOTE, mientras que el 23% de los datos fue recopilado directamente de usuarios a través de una platafo
...
Luego de hacer la transformacion volvemos a comparar la cantidad de ocurrencias para verificar que este balanceado la cantidad de unos y ceros.
