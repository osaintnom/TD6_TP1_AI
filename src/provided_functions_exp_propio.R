...
reemplazar_categorias <- function(categoria) {
  if (categoria %in% c("Insufficient_Weight", "Normal_Weight", "Overweight_Level_I", "Overweight_Level_II", "Obesity_Type_I", "Obesity_Type_II")) {
    return(0)
  } else if (categoria %in% c("Obesity_Type_III")) {
    return(1)
  } else {
    return(NA)
  }
...
write.csv(data, "./data/transformacion_1.csv", row.names = FALSE)
...
reemplazar_categorias <- function(categoria) {
  if (categoria %in% c("Insufficient_Weight", "Normal_Weight", "Overweight_Level_I", "Overweight_Level_II", "Obesity_Type_I")) {
    return(0)
  } else if (categoria %in% c("Obesity_Type_II","Obesity_Type_III")) {
    return(1)
  } else {
    return(NA)
  }
...
data$NObeyesdad <- sapply(data$NObeyesdad, reemplazar_categorias)
write.csv(data, "./data/transformacion_2.csv", row.names = FALSE)
...
data$NObeyesdad <- sapply(data$NObeyesdad, reemplazar_categorias)
write.csv(data, "./data/transformacion_3.csv", row.names = FALSE)
...
reemplazar_categorias <- function(categoria) {
  if (categoria %in% c("Insufficient_Weight", "Normal_Weight", "Overweight_Level_I")) {
    return(0)
  } else if (categoria %in% c("Overweight_Level_II", "Obesity_Type_I", "Obesity_Type_II", "Obesity_Type_III")) {
    return(1)
  } else {
    return(NA)
  }
...
data$NObeyesdad <- sapply(data$NObeyesdad, reemplazar_categorias)
write.csv(data, "./data/transformacion_4.csv", row.names = FALSE)
...
reemplazar_categorias <- function(categoria) {
  if (categoria %in% c("Insufficient_Weight", "Normal_Weight")) {
    return(0)
  } else if (categoria %in% c("Overweight_Level_I", "Overweight_Level_II","Obesity_Type_I", "Obesity_Type_II", "Obesity_Type_III")) {
    return(1)
  } else {
    return(NA)
  }
...
data$NObeyesdad <- sapply(data$NObeyesdad, reemplazar_categorias)
write.csv(data, "./data/transformacion_5.csv", row.names = FALSE)
